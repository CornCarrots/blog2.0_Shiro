...
//        throw new Exception();
    ...
    public String login(@RequestBody JSONObject jsonObject,HttpSession session)
    {
        ...
        String pass = jsonObject.get("userPassword").toString();
    ...
    public String register(@RequestBody JSONObject object,HttpSession session,HttpServletRequest request)
    {
