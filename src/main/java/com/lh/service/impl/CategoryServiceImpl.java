...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
//    @Cacheable(value = "cacheCategory",key = "'categories-'+#p0")
    ...
    @Override
//    @Cacheable(value = "cacheCategory",key = "'categories_parent-'+#p0")
    ...
    @Override
//    @Cacheable(value = "cacheCategory",key = "'categories_child-'+#p0")
