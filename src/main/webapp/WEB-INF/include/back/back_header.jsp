...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/role.css">
    <%--js文件--%>
    ...
    <script src="${pageContext.request.contextPath}/js/back/role.js"></script>
    <script src="${pageContext.request.contextPath}/js/back/permission.js"></script>
    <script src="${pageContext.request.contextPath}/js/back/module.js"></script>
    <script src="${pageContext.request.contextPath}/js/back/operation.js"></script>
    <script src="${pageContext.request.contextPath}/js/back/advertise.js"></script>
</head>
<body>
