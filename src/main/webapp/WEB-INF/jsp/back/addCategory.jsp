...
<div class="container">
    <div class="category">
        <ul class="breadcrumb">
            ...
            <li ><a href="${pageContext.request.contextPath}/admin/blog/categories">分类列表</a></li>
        ...
        <div class="addCategory">
            <div class="panel panel-success">
                ...
                <div class="panel-body" style="padding: 0">
                    <form action="${pageContext.request.contextPath}/admin/blog/categories" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
