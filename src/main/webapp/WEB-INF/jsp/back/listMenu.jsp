            ...
            <table class="table table-striped table-bordered table-hover  table-condensed">
                ...
                <c:forEach items="${menus}" var="menu">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-default editMenu" href="${pageContext.request.contextPath}/admin/show/menus/${menu.id}">编辑</a>
                            <button class="btn btn-warning deleteMenuOne" data-toggle="modal"
                                    nid="${pageContext.request.contextPath}/admin/show/menus/${menu.id}">删除
                            </button>
                        </td>
                    </tr>
                </c:forEach>
